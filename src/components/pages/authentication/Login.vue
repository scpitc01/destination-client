...
import { VContainer, VCard, VForm, VBtn, VDivider, VTextField, VCardText, VCardTitle, VLayout, VMain } from 'vuetify/lib/components'
...
export default {
    ...
    components: {
        Navbar,
        VContainer, VCard, VForm, VBtn, VDivider, VTextField, VCardText, VCardTitle, VLayout, VMain
    },
    methods: {
        async login() {
            try {
