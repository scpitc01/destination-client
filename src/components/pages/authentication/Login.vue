...
import { VContainer, VCard, VForm, VBtn, VDivider, VTextField, VCardText, VCardTitle, VLayout } from 'vuetify/lib/components'
...
export default {
    ...
    components: {
        Navbar,
        VContainer, VCard, VForm, VBtn, VDivider, VTextField, VCardText, VCardTitle, VLayout
    },
    methods: {
        async login() {
            try {
